...
public class admin_view_moving_assistance extends Fragment {
    ...
    public admin_view_moving_assistance() {
        // Required empty public constructor

    }

    public static admin_view_moving_assistance newInstance(String param1, String param2) {
        admin_view_moving_assistance fragment = new admin_view_moving_assistance();
        return fragment;
    }
    ...
    public void deleteMovingService(String identifier)
    {
        ...
        // Remove movingService from database
